"""
Code to solve the problem on a kind of rounded cross, for different values of l. 
...
f = open("outputs/output_euler_homo_star_problem_l_{l}_T_{T}_dt_{exp_dt}_h_P{deg}_viariate_degPhi_{sigma}.txt".format(T=int(T),l=degPhi,deg=degV,exp_dt=int(exp_dt), sigma=sigma), "w")
