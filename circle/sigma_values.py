"""
Code to solve the problem on the circle centered in (0,0) of radius 1, for different values of sigma. 
...
Sigma = [0.001,0.01,0.1, 1.0, 10., 20., 100., 1000., 10000]
# Polynome Pk
degV = 1
degPhi =  degV+1
# Ghost penalty
...
f = open("outputs/output_euler_homo_circle_problem_l_{l}_T_{T}_dt_{exp_dt}_h_P{deg}_variate_sigma.txt".format(T=int(T),l=degPhi,deg=degV,exp_dt=int(exp_dt)), "w")
